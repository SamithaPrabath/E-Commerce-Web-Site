<?php 
    ...
    session_start();
    $emailErr=$notMatchErr="";
    if(isset($_POST['login'])){
        $email=test_input($_POST['email']);
        $passwrd=$_POST['password'];
        if(!empty($email)){
            if(filter_var($email,FILTER_VALIDATE_EMAIL)){
                $query="select email,password,role from user where email='$email' and password='$passwrd';";
                ...
                if($row=mysqli_num_rows($result)==1){
                    ...
                    $notMatchErr="Invalid email or password";
                }
            }
            else{
                $emailErr="Inavlid Email";
            }
        }
        else{
            $emailErr="required";
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 main-col offset-md-3">
                    <div class="mb-4">
                        <form method="post" action="" id="CustomerLoginForm" accept-charset="UTF-8" class="contact-form">
                            <span style="color:red;"><?php echo $notMatchErr; ?></span>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="text-center col-12 col-sm-12 col-md-12 col-lg-12">
                                    <input type="submit" class="btn mb-3" value="Sign In" name="login">
                                    <p class="mb-4">
