            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-5">
                        <h1 class="h3 mb-0 text-gray-800 font-weight-bold">Messages</h1>

                    </div>

                    <div class="row">
                        <?php 
                            $query='select name,message,email,message_id from message;';
                            $result=mysqli_query($con,$query);
                            ...
                            <div class="card shadow mb-3">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <div class="sender_name">
                                        ...
                                        <a href="#">
                                            <h6 class="m-0 small text-secondary"><?php echo $row['email']; ?></h6>
                                        </a>
                                    </div>
                                    <div class="dropdown no-arrow">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                                            <a class="dropdown-item" href="remove_message.php?id=<?php echo $row['message_id']; ?>">Delete</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- Card Body -->
